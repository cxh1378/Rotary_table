...
var core = {
    ...
    /**List*/
    //gifts: ["一等奖","二等奖","三等奖","四等奖","五等奖","六等奖","七等奖","八等奖","九等奖","十等奖"],
    gifts: [],
    /**随机颜色*/
    colors: [],
    /***/
    ...
    /**初始化配置*/
    initConfig: function () {
        core.gifts.push(new Gift(1, "一等奖"));
    },
    ...
    lottery: function () {
        ...
        var step = TURNTABLE_CONFIG.BEGIN_ANGLE + Math.random() * 10;
        var angle = 0;
